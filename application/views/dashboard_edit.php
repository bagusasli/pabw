          ...
          <div class="account2">
              ...
              <ul class="list-unstyled navbar__list">
                <li>
                  ...
                  <li>
                      <a href="<?php echo site_url('Dashboard/c_edit') ?>">
                          <i class="fas fa-chart-bar"></i>Edit Data</a>
                  </li>
              </ul>
          </nav>
        </div>
  ...
  <div class="col-lg-9">
                ...
                <div class="card-body card-block">
                  ...
                  foreach($article as $a){ ?>
                    ...
                    <form action="<?php echo site_url('Dashboard/update') ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                      <input type="hidden" name="id" value="<?php echo $a->id ?>">
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="text" id="text-input" name="judul" value="<?php echo $a->judul ?>" class="form-control">
                                <small class="form-text text-muted">Masukkan Judul</small>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <textarea id="ckeditor" name="isi_artikel" id="textarea-input" rows="12" value="<?php echo $a->isi_artikel ?>" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <input type="date" id="date" name="tanggal" value="<?php echo $a->tanggal ?>" class="form-control">
                            </div>
                        </div>
                        <div class="row form-group">
                            <div class="col col-md-3">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="lokasi" id="selectLg" class="form-control-lg form-control" value="<?php echo $a->lokasi ?>">
                                    <option value="---">---</option>
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-12 col-md-9">
                                <select name="kategori" id="selectLg" class="form-control-lg form-control" value="<?php echo $a->kategori ?>">
                                    <option value="---">---</option>
		...
		<script type="text/javascript">
			var ckeditor = CKEDITOR.replace('isi_artikel',{
				height: '400px'
			});
